...
public class listagemContratanteEndereco {
	...
	public static void main (String[] args){
		...
		List<Endereco> testeConsulta = enderecoRN.listarPorContratante(codigo);
		
		for( Endereco doEnderecoList : testeConsulta ){
			System.out.println(doEnderecoList.getLogradouro() + " --> " + doEnderecoList.getContratante().getNome());
		}
