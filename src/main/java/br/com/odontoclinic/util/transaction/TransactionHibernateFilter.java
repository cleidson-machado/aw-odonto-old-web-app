package br.com.odontoclinic.util.transaction;
...
//Moldada para funcionar somente com o Desing Patterns do Livro..

@WebFilter(urlPatterns = { "*.xhtml" })
public class TransactionHibernateFilter implements Filter {
